    ...
    >
      <AnimatePresence mode="wait">
        {!showSplit ? (
          ...
          <motion.div
            key="split"
            className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-6xl py-8 md:py-12 md:p-20 md:max-w-3xl"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            transition={{ duration: 1 }}
          >
            {/* Left content */}
            <motion.div
              className="flex flex-col justify-center space-y-4 sm:space-y-6 px-4 md:px-0 text-center md:text-left"
            ...
            <motion.div
              ...
              transition={{ duration: 1, ease: "easeOut" }}
            >
              <div className="w-44 sm:w-48 md:w-60 h-auto bg-white shadow-lg rounded-2xl p-4 flex flex-col justify-between mb-4 sm:mb-6 mx-auto md:mx-0">
                <div>
